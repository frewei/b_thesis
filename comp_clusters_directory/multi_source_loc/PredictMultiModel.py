#Generate predictions of models
...
# Predicting the model with the best weights (checkpoint models) for original multi-source model
...
# Predicting the model with the best weights (checkpoint models) for altered multi-source model
