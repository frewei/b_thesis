...
os.environ["CUDA_VISIBLE_DEVICES"] = "6" # GPU 6 on computational clusters
...
# function that create array of only first labels so the arrays are only stratified over first labels
first_label = []
...
log_dir = "/home/frewei/logs/multi_source/" + "NewMS1_same_BS_8"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)

# final model that was used in predictions
checkpoint_filepath = "/home/frewei/multi_source_loc/models/multi_checkpoint1_bs8.model.keras"
...
model.save('/home/frewei/multi_source_loc/models/model_NewMS1_same_BS_8.keras')
